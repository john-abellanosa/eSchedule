...
class ManagerChangePasswordPage extends StatefulWidget {
  const ManagerChangePasswordPage({Key? key}) : super(key: key);

  @override
  State<ManagerChangePasswordPage> createState() =>
      _ManagerChangePasswordPageState();
}

class _ManagerChangePasswordPageState extends State<ManagerChangePasswordPage> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  'Your manager password has been changed successfully.',
