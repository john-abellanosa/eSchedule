...
import 'package:escheduler/features/manager/pages/manager_request_page/request_form/give_away_request_form.dart';
import 'package:escheduler/features/manager/pages/manager_request_page/request_form/swap_request_form.dart';
import 'package:escheduler/features/manager/pages/manager_request_page/request_form/off_duty_request_form.dart';
...
class _ManagerRequestPageState extends State<ManagerRequestPage>
  ...
  // Sample data for Requests (Swap and Give Away) with POSITIONS instead of departments/stations
  final List<Request> _requests = [
    Request(
      id: '1',
      type: 'Swap',
      fromEmployee: 'Sarah Johnson',
      fromPosition: 'Shift Leader',
      fromTimeIn: '09:00 AM',
      fromTimeOut: '05:00 PM',
      toPosition: 'Service Manager',
      toTimeIn: '10:00 AM',
      toTimeOut: '06:00 PM',
      date: 'Mon, Dec 15',
              ...
              children: [
                ...
                if (isSwap) ...[
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: _buildSwapPositionSection(
  ...
  // Helper method: Position details section (for non-swap)
  ...
  // Helper method: Swap position section with background
  Widget _buildSwapPositionSection({
    required IconData icon,
    required String title,
    required String position,
    required String timeIn,
  ...
  Widget _buildStatusTab() {
    ...
    final List<dynamic> _statusRequests = [
      // EXAMPLE 1: Swap Schedule - Only Co-worker Approved
      {
        'type': 'Swap',
        'id': '1',
      ...
      // Off Duty Request - Pending Admin Approval
      {
        'type': 'Off Duty',
        'id': 'O1',
        'fromEmployee': 'Yourself',
        ...
        return Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(4),
              border: Border.all(color: const Color(0xFF16A34A), width: 0.5),
            ),
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
  ...
  // Helper method: Build cancel button
                    ...
                    children: [
                      Expanded(
                        child: _buildSwapPositionSection(
                          icon: Icons.work_outline,
                          title: 'Their Position',
                          position: data['fromPosition'] as String,
                      ...
                      Expanded(
                        child: _buildSwapPositionSection(
                          icon: Icons.swap_horiz,
                          title: 'Your Position',
                          position: data['toPosition'] as String,
  ...
  // Completed Swap and Give Away Card
  ...
  // Completed Off Duty Request Card
  ...
  Widget _buildCancelledTab() {
    // Sample data for Cancelled Tab
    final List<dynamic> _cancelledRequests = [
      // EXAMPLE 1: Swap Schedule - Declined by Co-worker
      {
        'type': 'Swap',
        'id': 'X1',
      ...
      // EXAMPLE 2: Give Away Schedule - Declined by Admin
      {
        'type': 'Give Away',
        'id': 'X2',
      ...
      // EXAMPLE 3: Leave Request - Cancelled by me
      {
        'type': 'Leave',
        'id': 'X4',
        'fromEmployee': 'Yourself',
      ...
      // EXAMPLE 4: Off Duty Request - Declined by Admin
      {
        'type': 'Off Duty',
        'id': 'X5',
        'fromEmployee': 'Yourself',
  ...
  // Helper method: Build cancelled status badges
        ...
        return Padding(
          ...
          child: Container(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.cancel, size: 12, color: const Color(0xFFDC2626)),
                const SizedBox(width: 6),
                Text(
                  status,
                  style: const TextStyle(
  ...
  // Cancelled Swap and Give Away Card
  ...
  // Cancelled Off Duty Request Card
...
// Data Model for Requests with POSITIONS instead of departments/stations
class Request {
  final String id;
  final String type; // 'Swap' or 'Give Away'
  final String fromEmployee;
  final String fromPosition; // Changed from department
  final String fromTimeIn;
  final String fromTimeOut;
  final String toPosition; // Changed from department (for swaps only)
