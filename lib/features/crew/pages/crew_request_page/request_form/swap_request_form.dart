...
void showSwapRequestForm(BuildContext context, {bool isEdit = false}) {
  ...
  List<String> getStationOptions(String? department) {
    if (department == 'Front Counter')
      return ['Counter 1', 'Counter 2', 'Drive-Thru Presenter'];
    if (department == 'Drive Thru')
      return ['Order Taker', 'Cashier', 'Present Window'];
    if (department == 'Kitchen')
      return ['ASM/Grill', 'Fry Station', 'Prep Station'];
    return [];
  }
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      dropdownField(
                        items: const ['Front Counter', 'Drive Thru', 'Kitchen'],
                        onChanged: (v) {
                          setState(() {
                            myDepartment = v;
                            myStation = null;
                      ...
                      const SizedBox(height: 6),
                      dropdownField(
                        items: getStationOptions(myDepartment),
                        value: myStation,
                        onChanged: (v) {
                          setState(() => myStation = v);
                        },
                      ),
                      const SizedBox(height: 12),
                      Row(
                      ...
                      const SizedBox(height: 6),
                      dropdownField(
                        items: getStationOptions(partnerDepartment),
                        value: partnerStation,
                        onChanged: (v) {
                          setState(() => partnerStation = v);
                        },
                      ),
                      const SizedBox(height: 12),
                      Row(
