...
void showGiveAwayRequestForm(BuildContext context, {bool isEdit = false}) {
  ...
  String? department, station, receiver;

  List<String> getStationOptions(String? dept) {
    if (dept == 'Front Counter')
      return ['Counter 1', 'Counter 2', 'Drive-Thru Presenter'];
    if (dept == 'Drive Thru')
      return ['Order Taker', 'Cashier', 'Present Window'];
    if (dept == 'Kitchen') return ['ASM/Grill', 'Fry Station', 'Prep Station'];
    return [];
  }
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                dropdownField(
                  items: getStationOptions(department),
                  value: station,
                  onChanged: (v) => setModalState(() => station = v),
                ),
                const SizedBox(height: 20),
                const Text(
